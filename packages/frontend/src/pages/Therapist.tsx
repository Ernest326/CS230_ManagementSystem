...
export default function Therapist() {
    ...
    const columns = [
        { head: '#', accessor: 'therapist_id' },
        { head: 'Title', accessor: 'title' },
    ...
    const endpoint = 'http://localhost:3000/therapists';
    const primaryKey = 'therapist_id';
    ...
    return (
        ...
        <h1 className="mt-5 bold text-center text-6xl">Therapists</h1>
        <div className="mt-5 mb-2 flex-col">
            ...
            onClick={makeColumn}>Add Therapist</button>
        </div>
